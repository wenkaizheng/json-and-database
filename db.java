...
public class db {
	...
	public void insert(weapon w,int num) {
		...
		// sql = "INSERT INTO REGISTRATION VALUES (" + "'" + name + "', " + dam + ", " + shot + ", " + acc + ", " + "'"
			//	+ des + "')" ;
		...
		sql =String.format("INSERT INTO Registration VALUES (%d, '%s', %d, %f, %d, '%s')", num,name,dam,shot,acc,des);
	...
	public int create() {
		...
		try {
			...
			String column = "CREATE TABLE REGISTRATION " + "(id INTEGER not NULL , "
					+ " added datetime, " + " name VARCHAR(255), "
					+ " damage int(200), " + " persecond DOUBLE(100), "
					+ " acc int(200), " + " des VARCHAR(255), "
                    + " PRIMARY KEY ( id ))";
                    **/
			 
			String column = "CREATE TABLE REGISTRATION " +
	                   "(id INTEGER not NULL, " +
	                   " name VARCHAR(255), " + 
	                   " damage INTEGER, " + 
	                   " persecond DOUBLE, " + 
